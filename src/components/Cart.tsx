      ...
      <div className="cart-content">
        ...
        <div className="badge-in-images">
          ...
          <ul className="badge-list">
            <li>
              <img src={store1} alt="Store 1" className="badge-image" />
            </li>
            <li>
              <img src={store2} alt="Store 2" className="badge-image" />
            </li>
            <li>
              <img src={store3} alt="Store 3" className="badge-image" />
            </li>
          </ul>
        </div>
        <div className="cart">
          ...
          <ul className="cart-items">
            ...
            {cartItems.map((item) => (
              <li key={item.upc} style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "5px" }}>
                <span>{item.name} {item.quantity && `x${item.quantity}`}</span>
                <button onClick={() => removeItem(item.upc)} style={{ marginLeft: "auto" }}>Remove</button>
              </li>
            ))}
          </ul>
        </div>
